...
GPT-5 Codex optimized candidate `9b58e4430d9b` against exact promoted
...
- `secure_composition.zig`, installed by `commit_backend.zig`, implements the
...
| --- | ---: | ---: | ---: | ---: |
| Metal xlarge `mwf_log18x100` | 139.119 ms | 131.618 ms | 0.946933 [0.938837, 0.956455] | 5.31% |
| Metal huge `mwf_log20x100` | 493.774 ms | 464.245 ms | 0.945997 [0.928870, 0.956027] | 5.40% |

Request-time ratios are 0.969473 and 0.972452. Peak-RSS ratios are 1.000151
and 0.999972; energy ratios are 0.942124 and 0.935730. Proof sizes remain
...
adapter at 40 lines. The 363-source ReleaseFast closure passes, including CPU,
Metal, aggregate, and tests. Three alternated profiles before final gating put predecessor huge
