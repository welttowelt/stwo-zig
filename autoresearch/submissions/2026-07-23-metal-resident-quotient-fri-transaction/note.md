...
`a94b70436d2f`, rebased onto and paired against
current main `2beae9d03b33bc9c5b0b21bb445439799786f2fb`. The repository-resident
`stwo-perf` harness identity is `4298fb2735af`; builds use Zig 0.15.2
...
| --- | ---: | ---: | ---: |
| prove median | 4.706750 ms | 4.262042 ms | **0.904337 [0.882816, 0.923730]** |
| verified request | — | — | 0.905364 |
| energy | — | 0.303531 J | 0.997752 [0.986580, 1.007611] |
| peak RSS | — | 165.173 MiB | 1.017520 [1.017082, 1.017618] |
...
repository's 850-line manual-source ceiling. Final candidate `a94b70436d2f`
