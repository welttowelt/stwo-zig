...
The checked-in enforcement baseline contains 29 explained legacy findings: 1 dependency edge,
14 oversized manually maintained files, and 14 misplaced root sources. Each size exception records
