...
The checked-in enforcement baseline contains 31 explained legacy findings: 1 dependency edge,
15 oversized manually maintained files, and 15 misplaced root sources. New findings and stale
