...
The checked-in enforcement baseline contains 26 explained legacy findings: 1 dependency edge,
13 oversized manually maintained files, and 12 misplaced root sources. Each size exception records
