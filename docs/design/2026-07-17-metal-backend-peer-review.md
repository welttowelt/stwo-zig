...
5. [ ] Generate packed SIMD and Metal constraint evaluators from authenticated AIR semantics.
   ...
   legacy kernels from fused builds. Component-prefix artifacts provide the bounded cumulative
   Rust-oracle loop; SIMD generation and production cap selection remain open.
