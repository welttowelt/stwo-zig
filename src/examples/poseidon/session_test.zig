...
test "Poseidon session: compatibility, prepared, and sequential proofs match exactly" {
    ...
    try std.testing.expectEqual(@as(usize, 102_548), expected.len);

    var digest: [std.crypto.hash.sha2.Sha256.digest_length]u8 = undefined;
    std.crypto.hash.sha2.Sha256.hash(expected, &digest, .{});
    try std.testing.expectEqualSlices(u8, &[_]u8{
        0x6d, 0xa1, 0x04, 0x87, 0xee, 0x7d, 0xb3, 0xc6,
        0xec, 0x88, 0x76, 0xb8, 0xe9, 0x3e, 0x46, 0xe4,
        0x46, 0x5b, 0x3b, 0x01, 0x49, 0x66, 0x50, 0x46,
        0x09, 0x43, 0x2d, 0x2b, 0x11, 0xc0, 0xfd, 0x56,
    }, &digest);
