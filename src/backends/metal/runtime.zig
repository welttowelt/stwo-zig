...
const stwo_zig_metal_witness_input_gather = resident_data_bindings.stwo_zig_metal_witness_input_gather;
const stwo_zig_metal_execution_table_split = resident_data_bindings.stwo_zig_metal_execution_table_split;
const stwo_zig_metal_memory_address_base_trace = resident_data_bindings.stwo_zig_metal_memory_address_base_trace;
const stwo_zig_metal_memory_value_base_trace = resident_data_bindings.stwo_zig_metal_memory_value_base_trace;
const stwo_zig_metal_memory_rc99_count = resident_data_bindings.stwo_zig_metal_memory_rc99_count;
const stwo_zig_metal_public_memory_seed = resident_data_bindings.stwo_zig_metal_public_memory_seed;
const stwo_zig_metal_leaf_absorb = resident_data_bindings.stwo_zig_metal_leaf_absorb;
const stwo_zig_metal_leaf_absorb_compact = resident_data_bindings.stwo_zig_metal_leaf_absorb_compact;
const stwo_zig_metal_parent_seeded = resident_data_bindings.stwo_zig_metal_parent_seeded;
const stwo_zig_metal_parent_plain = resident_data_bindings.stwo_zig_metal_parent_plain;
const stwo_zig_metal_qm31_to_coordinates = resident_data_bindings.stwo_zig_metal_qm31_to_coordinates;
const stwo_zig_metal_felt252_oracle = resident_data_bindings.stwo_zig_metal_felt252_oracle;
const stwo_zig_metal_merkle_commit = resident_data_bindings.stwo_zig_metal_merkle_commit;
